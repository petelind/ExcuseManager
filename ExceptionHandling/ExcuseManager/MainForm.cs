...
namespace ExcuseManager
{
    public partial class MainForm : Form
    {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog1.Filter = "Excuse files | *.ex";
            saveFileDialog1.DefaultExt = "ex";
        ...
        private void buttonOpen_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.Filter = "Excuse files | *.ex";
        ...
        {
            string[] excuseFiles;
            excuseFiles = Directory.GetFiles(currentFolder, "*.ex", SearchOption.AllDirectories);
            ...
            else
            {
                ...
                int numOfExcuseToLoad = random.Next(0, excuseFiles.Count());
